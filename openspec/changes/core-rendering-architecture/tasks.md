...
- [x] 13.3 Detect truecolor / synchronized-output / unicode-width support; record fallbacks
- [x] 13.4 Tests: live window reflows on width change; cap recomputes; no rewrite of frozen content
